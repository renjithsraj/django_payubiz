...
LONG_DESCRIPTION = """ payu_biz is wrapper for payu payment gateway for django framework"""
...
setup(
  ...
  keywords = ['payment gateway python package','payu', 'payu python package','payment gateway', 'payu gateway django', 'django gateway package'], # arbitrary keywords
  classifiers=[
